...
SYSTEM_PROMPT_INQUIRY = """
    ...
    【条件】
    1. ユーザー入力内容と以下の文脈との間に関連性がある場合、以下の文脈に基づいて詳細に回答してください。単価や数値、表データ等が含まれている場合は、それらを可能な限り具体的に記載してください。
    2. ユーザー入力内容と以下の文脈との関連性が明らかに低い場合のみ、「回答に必要な情報が見つかりませんでした。」と回答してください。
