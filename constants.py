...
# プロンプトテンプレート
# ==========================================
SYSTEM_PROMPT_CREATE_INDEPENDENT_TEXT = "会話履歴と最新の入力をもとに、検索に適した独立したキーワードや文章を作成してください。"
...
SYSTEM_PROMPT_INQUIRY = """
    ...
    以下の【文脈】に含まれる情報を読み取り、ユーザーの質問に回答してください。

    【条件】
    1. 【文脈】の中に質問に関連する情報（単価、価格、職種、数値、記述など）が含まれている場合は、それらの情報を整理し、表や箇条書き等を用いて具体的に回答してください。
    2. 単価表などのデータがある場合は、主要な数値や内容を可能な限り詳しく書き起こしてください。
    3. 【文脈】の中に質問と完全に関連しない情報しかない場合のみ、「回答に必要な情報が見つかりませんでした。」と回答してください。
    4. 回答はマークダウン記法で整形して出力してください。
