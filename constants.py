...
SYSTEM_PROMPT_INQUIRY = """
    ...
    【条件】
    1. 以下の文脈の中にユーザーの質問に関連する情報（数値、単価、表、テキスト等）が含まれている場合、その内容を元に具体的かつ分かりやすく回答してください。
    2. 単価表や一覧データが含まれる場合は、該当する職種や金額等を書き起こして提示してください。
    3. 以下の文脈の中にユーザー入力に関連する情報が全く含まれていない場合のみ、「回答に必要な情報が見つかりませんでした。」と回答してください。
