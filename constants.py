...
SYSTEM_PROMPT_INQUIRY = """
    ...
    【条件】
    1. 提供された【文脈】情報を最優先で参照して、ユーザーの質問に回答してください。
    2. 文脈に直接的な記述がない場合でも、関連する推測や一般的な知識で補完できる場合は、その旨を明記した上で丁寧に回答してください。
    3. 全く手がかりが存在しない場合のみ「回答に必要な情報が見つかりませんでした。」と回答してください。
